...
def generate_fake_orders_data(num_records=50):
    ...
    payments_ids = get_payments_ids_to_process()
    address_ids = get_address_ids_to_process()
    customer_ids = get_customer_ids_to_process()
    sales_channel_ids = get_sales_channel_ids_to_process()
